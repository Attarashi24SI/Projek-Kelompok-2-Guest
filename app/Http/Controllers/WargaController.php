...
class WargaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('guest.warga.index')->with('success', 'Data warga berhasil disimpan!');
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('guest.warga.index')->with('error', 'Data tidak ditemukan!');
    }
