                ...
                <div class="row g-5">
                    ...
                    <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
                        <div class="about-item">
                            ...
                            <h1 class="display-3 mb-3">Projek Bina Desa</h1>
                            <p class="mb-4">Bina Desa adalah program pengabdian masyarakat yang bertujuan untuk meningkatkan
                                kesejahteraan dan kemandirian masyarakat desa melalui penerapan ilmu pengetahuan, teknologi,
                                serta inovasi sosial. Program ini menjadi wadah kolaborasi antara mahasiswa, masyarakat, dan
                                pemerintah desa dalam mengembangkan potensi lokal secara berkelanjutan.
                            </p>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="d-flex">
                                            ...
                                            <div class="">
                                                <a href="#" class="h4 d-inline-block mb-3">Pengembangan Potensi Desa</a>
                    ...
                    <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="product-item">
                            ...
                            <div class="product-content bg-light text-center rounded-bottom p-4">
                                ...
                                <p class="fs-4 text-primary mb-3"></p>
                                <a href="{{ route('guest.perangkat.lembaga.index') }}" class="btn btn-secondary rounded-pill py-2 px-4">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
