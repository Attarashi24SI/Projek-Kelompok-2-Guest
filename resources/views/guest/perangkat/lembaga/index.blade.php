...
<body>
    ...
    <div class="container-fluid feature bg-light py-5">
        <div class="container py-5">
            ...
            <a href="{{ route('guest.perangkat.lembaga.create') }}" class="btn btn-primary mb-3">+ Tambah Data</a>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-3 shadow-sm">
                            <div class="card-body">
                                ...
                                <a href="{{ route('guest.perangkat.lembaga.edit', $lembaga->lembaga_id) }}"
                                    class="btn btn-primary mb-2">Edit</a>

                                <a href="{{ route('guest.perangkat.lembaga.destroy', $lembaga->lembaga_id) }}"
