        ...
        <div class="container py-5">
            <div class="text-center mx-auto pt-5 pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                ...
                @if (auth()->check() && auth()->user()->role === 'user')
                    <h1 class="display-5 mb-4">Data Lembaga Desa</h1>
                @endif
            </div>
            @if (auth()->check() && auth()->user()->role === 'admin')
                ...
                @foreach ($dataLembaga as $lembaga)
                    <div class="col-md-4">
                        <div class="card mb-3 shadow-sm">
                            ...
                            <img src="{{ $imgUrl }}"
                                onerror="this.onerror=null; this.src='{{ asset('images/alternative/default.png') }}';"
                                class="card-img-top" style="width:100%; height:220px; object-fit:cover;"
                                alt="Gambar Lembaga">
