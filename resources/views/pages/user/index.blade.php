                                ...
                                <div class="card mb-3 shadow-sm border-0">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('user.edit', $user->id) }}" class="btn btn-primary btn-sm"><img
                                                    src="https://cdn-icons-png.flaticon.com/128/14034/14034300.png"
                                                    style="width:15%;" alt="">Edit</a>
                                            ...
                                            <form action="{{ route('user.destroy', $user->id) }}" method="POST"
                                                ...
                                                <button class="btn btn-danger btn-sm"><img
                                                        ...
                                                        style="width:15%; height:15%;" alt="">Hapus</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
