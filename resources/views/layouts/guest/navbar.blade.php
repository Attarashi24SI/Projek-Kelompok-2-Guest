<div class="container-fluid position-relative p-0">
    <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
        <a href="{{ url('/home') }}" class="navbar-brand p-0">
            <h1 class="text-primary"><i class="fas fa-hand-holding-water me-3"></i>Bina Desa</h1>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="{{ route('pages.warga.index') }}" class="nav-item nav-link">Warga</a>
                <a href="{{ route('pages.perangkat.lembaga.index') }}" class="nav-item nav-link">Lembaga</a>
                ...
                @auth
                    ...
                    <a class="nav-link">
                        <img src="https://cdn-icons-png.flaticon.com/128/17701/17701286.png"
                            style="width:24px; height:24px;" alt="icon">
                    </a>
