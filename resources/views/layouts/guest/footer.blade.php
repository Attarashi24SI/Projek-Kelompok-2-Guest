...
<!-- Copyright Start -->
<div id="fixedFooter" class="container-fluid copyright py-4"
    style="display:none; position:fixed; bottom:0; width:100%; z-index:999;">
    <div class="container">
        <div class="row g-4 align-items-center">
            <div class="col-md-6 text-center text-md-start mb-md-0">
                <span class="text-body"><a href="#" class="border-bottom text-white">
                    <i class="fas fa-copyright text-light me-2"></i>Perangkat Dan Lembaga
                </a>, All right reserved.</span>
            </div>
            <div class="col-md-6 text-center text-md-end text-body">
                Designed By <a class="border-bottom text-white" href="#">Attarashi</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    window.addEventListener("scroll", function() {
        ...
        if ((window.innerHeight + window.scrollY) >= document.body.offsetHeight - 10) {
            footer.style.display = "block"; // munculkan
        } else {
            footer.style.display = "none"; // sembunyikan ketika belum di bottom
        }
    });
</script>
